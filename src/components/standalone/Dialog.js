...
class DialogueNote extends React.Component {
    // state = {
    //     title: '',
    //     note: '#',
    //     archiveStatus: false,
            ...
            <div>
                <ClickAwayListener onClickAway={this.createNewList} >
                    <Paper className={classes.shadow}>
                        ...
                        <Paper component="form" className={classes.takeNote} >
                            <IconButton className={classes.editIcon} onClick={()=>console.log(this.props.text)}><AddAlertIcon /></IconButton>
...
export default withStyles(styles)(DialogueNote);